...
export default function TestimonialCard({ testy, company }: Testimonial) {
  return (
    <div className="w-full sm:w-1/3 flex flex-col justify-between px-4 sm:px-5 py-4 sm:py-5  border-gray-600 sm:border-t-0 sm:border-l first:border-t-0 first:border-l-0">
